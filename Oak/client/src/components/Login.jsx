                ...
                >
                    ...
                    >
                        ...
                        <p className="text-blue-600 text-lg max-w-md">
                            Connect with your audience through powerful media solutions.
                        </p>
                    </motion.div>
                ...
                >
                    ...
                    <form onSubmit={submitHandler} className="space-y-6">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            disabled={loading}
                            className={`w-full py-3 px-4 rounded-lg font-medium text-white ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} transition flex items-center justify-center`}
                        >
                            {loading ? (
                                <>
