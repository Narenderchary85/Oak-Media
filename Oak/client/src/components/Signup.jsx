...
const Signup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:1000/auth/signin', signupData);
      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        >
          ...
          >
            <div className="flex items-center mb-4">
              <SiLoop className="w-12 h-12 text-blue-500 mr-2" />
            ...
            <p className="text-blue-600 text-lg max-w-md">
              Create an account to connect with your audience through powerful media solutions.
            </p>
          </motion.div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Join Oak Media today</p>
          </div>
            ...
            <div className="mt-4">
              <Link to="/login">
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-2 px-4 border border-gray-300 rounded-lg font-medium text-blue-600 hover:bg-gray-50 transition"
                >
                  Sign in
                </motion.button>
              </Link>
